...
// UserLimitsValues are properties used to modify user limits (max-connections, max-channels).
type UserLimitsValues map[string]int

// UserLimits specifies which user limits to delete.
...
// GetUserLimits returns limits for a user.
